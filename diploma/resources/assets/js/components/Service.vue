<template>
<div>
 <div id ="servicePage" class="shadow-sm"></div>
      ...
      methods: {
        ...
        showCardInfo: function (e) {
          ...
          axios.get('/getService/'+e.target.id).then((response) => {
            ...
            document.getElementById('servicePage').innerHTML += "<div style='display:inline-block;vertical-align:top;width: 60%;text-align: center; margin-top:20px;'><h1 style=''>"+this.service.name+"</h1><h3>Description:</h3>"+this.service.description+"</h3>"+""+"<h3>Price:<br>"+this.service.price+"</h3></h3><h3 style='margin-top:20px;'>Time:<br>"+this.service.count_time+"</h3>"+"<h3 style='margin-top:20px;font-size:15px;'><a href ='#'><img style='width:150px; height:40px;' src='img/banki.jpg'></a>"+"</div>";
